          ...
          <q-card class="bg-grey-2 no-shadow" bordered>
            ...
            <q-card v-if="showCard1" class="bg-grey-2 no-shadow" bordered>
              <q-card-section horizontal>
                <q-card-section class="col-5 flex flex-center">
                  <q-img height="80px" class="rounded-borders"
                    src="https://www.acouplecooks.com/wp-content/uploads/2019/06/Mushroom-Pizza-with-Herbs-011.jpg" />
                </q-card-section>
                <q-card-section class="col-7">
                  <div class="separate">
                    <div class="text-subtitle2 q-mt-sm">Pizza Mushroom's</div>
                    <div class="text-subtitle2  q-mb-xs">$17.5</div>
                  </div>
            ...
            <q-card v-if="showCard2" class="bg-grey-2 no-shadow" bordered>
              <q-card-section horizontal class="q-pa-none">
                <q-card-section class="col-5 flex flex-center">
                  <q-img height="80px" class="rounded-borders"
                    src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.thecandidcooks.com%2Fpizza-of-the-month-spicy-sausage-and-pepper-pizza%2F&psig=AOvVaw2T5rnHAqoHsWq4i7EcwT-x&ust=1687156114011000&source=images&cd=vfe&ved=0CBEQjRxqFwoTCNjutLyYzP8CFQAAAAAdAAAAABAD" />
                </q-card-section>
                <q-card-section class="col-7">
                  <div class="separate">
                    <div class="text-subtitle2 q-mt-sm">Spicy Pizza</div>
                    <div class="text-subtitle2  q-mb-xs">$12.0</div>
                  </div>
                  <div class="flex justify-end">
            ...
            <q-card v-if="showCard3" class="bg-grey-2 no-shadow" bordered>
              <q-card-section horizontal class="q-pa-none">
                <q-card-section class="col-5 flex flex-center">
                  <q-img height="80px" class="rounded-borders"
                    src="https://www.thecandidcooks.com/wp-content/uploads/2022/08/spicy-sausage-pepper-pizza-feature.jpg" />
                </q-card-section>
                <q-card-section class="col-7">
                  <div class="separate">
                    <div class="text-subtitle2 q-mt-sm">Pizza quatro formages</div>
                    <div class="text-subtitle2  q-mb-xs">$60</div>
                  </div>
                  <div class="flex justify-end">
            ...
            <q-card-section class="row">
              <div class="col-12 text-h6 full-width">
                ...
                <div class="float-right">
                  Total : <span class="text-blue">$99.5</span>
                </div>
              </div>
            </q-card-section>
          ...
          <q-stepper v-model="step" header-nav ref="stepper" color="primary" class="no-shadow" bordered animated>
            <q-step :name="1" title="Shipping address" icon="shopping_cart" :done="step > 1" :header-nav="step > 1">
              <div class="row">
                <div class="col-6">
                  <q-item>
                    <q-input dense autogrow outlined v-model="address_details.first_name" class="full-width"
                      label="First Name" :rules="[val => !!val || 'This field is required']"
                      @input="validateAddressDetailsForm" />
                  </q-item>
                </div>
                <div class="col-6">
                  <q-item>
                    <q-input dense autogrow outlined v-model="address_details.last_name" class="full-width"
                      label="Last Name" :rules="[val => !!val || 'This field is required']"
                      @input="validateAddressDetailsForm" />
                  </q-item>
                </div>
                <div class="col-12">
              ...
              <q-stepper-navigation>
                <q-btn rounded @click="() => { done1 = true; step = 2 }" class="float-right q-mr-md q-mb-md"
                  color="cyan-8" label="Next" :disabled="!isFormValid" />
              </q-stepper-navigation>
            </q-step>
            ...
            <q-step :name="2" title="Payment details" icon="shopping_cart" :done="step > 2" :header-nav="step > 2">
              ...
              <div class="row">
                ...
                <div class="col-6">
                  <q-item>
                    <q-input dense autogrow outlined class="full-width" v-model="card_details.card_number"
                      label="Card Number" :rules="[val => !!val || 'This field is required']"
                      @input="validateCardDetailsForm" />
                  </q-item>
                </div>
                <div class="col-6">
                  <q-item>
                    <q-input dense autogrow outlined v-model="card_details.expiry_date" class="full-width"
                      label="Expiry Date" :rules="[val => !!val || 'This field is required']"
                      @input="validateCardDetailsForm" />
                  </q-item>
                </div>
                <div class="col-6">
              ...
              <q-stepper-navigation>
                <q-btn rounded @click="() => { done2 = true; step = 3 }" color="cyan-8" label="Next"
                  class="float-right q-mr-md q-mb-md" :disabled="!isCardDetailsValid" />
            ...
            <q-step :name="3" title="Review your order" icon="shopping_cart" :header-nav="step > 3">
              ...
              <q-stepper-navigation>
                ...
                <q-btn rounded @click="done3 = true" color="cyan-8" label="Place Order"
